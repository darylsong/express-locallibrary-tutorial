...
exports.book_update_get = function(req, res, next) {
    ...
    async.parallel(
        ...
        function(err, results) {
            ...
            // There are no results for this particular book
            ...
            // Book found
            // Mar our selected genres as checked
...
exports.book_update_post = [
    ...
    (req, res, next) => {
        ...
        // Create a book object with escpaed/trimmed data and old id
        var book = new Book({
            title: req.body.title,
            author: req.body.author,
            summary: req.body.summary,
        ...
        if (!errors.isEmpty()) {
            // There are errors. Render form again sanitized values/error messages.
            ...
            async.parallel(
                ...
                function(err, results) {
                    ...
                    res.render('book_form', {title: 'Update Book', authors: results.authors, genres: results.genres, book: book });
                }
            );
